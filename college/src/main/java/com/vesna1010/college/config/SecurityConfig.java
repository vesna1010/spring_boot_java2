...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
		        ...
		        .antMatchers("/departments", "/departments/").authenticated()
		        .antMatchers("/study_programs", "/study_programs/").authenticated()
		        .antMatchers("/subjects", "/subjects/").authenticated()
		        .antMatchers("/students", "/students/").authenticated()
		        .antMatchers("/exams", "/exams/").authenticated()
				.antMatchers("/exams/search").authenticated()
				.antMatchers("/users/edit").authenticated()
				.antMatchers("/students/exams").authenticated()
